...
export const ShortsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m13 10 3-3m0 0-3-3m3 3h-3.328a4 4 0 0 0-3.832 2.5l-.84 1.682a4 4 0 0 1-3.832 2.5H3m14 4-3 3m0 0-3 3m3-3h3.328a4 4 0 0 0 3.832-2.5l.84-1.682a4 4 0 0 1 3.832-2.5H21" />
    </svg>
);

export const SubscriptionsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const DislikeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 15v4a3 3 0 003 3l4-9V3H5.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3H10z" />
    </svg>
);
...
export const GamingIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const BookmarkIcon: React.FC<IconProps & { filled?: boolean }> = ({ className = 'w-6 h-6', filled = false }) => (
